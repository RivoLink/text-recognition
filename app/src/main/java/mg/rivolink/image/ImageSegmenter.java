package mg.rivolink.image;

import java.util.*;

/**
 * ImageSegmenter - Segments handwritten text images into individual characters
...
public class ImageSegmenter {
    ...
    /**
     * Segments an image into individual character bounding boxes
     * 
     * @param image Flattened pixel array (row-major order), values in [0, 1]
     ...
     */
    public static List<CharacterBound> segmentCharacters(float[] image, int width, int height) {
     ...
     */
    private static CharacterBound findConnectedComponent(float[] image, boolean[] visited,
     ...
     */
    private static float[] resizeWithBilinear(float[] image, int imageWidth, int imageHeight,
                                             CharacterBound bound, int targetSize) {
