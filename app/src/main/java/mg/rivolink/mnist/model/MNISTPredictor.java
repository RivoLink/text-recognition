...
/**
 * MNISTPredictor - Makes predictions on new handwritten digit/letter images
 */
public class MNISTPredictor {
    ...
    // Legacy constructor for MNIST compatibility
    public MNISTPredictor(Network network) {
        this(network, MNISTTrainer.DatasetType.MNIST);
    }
