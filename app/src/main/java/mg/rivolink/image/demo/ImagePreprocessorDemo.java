...
public final class ImagePreprocessorDemo {

    private ImagePreprocessorDemo() {
        // utility class
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("=== Image Pre-processing Demo ===");
        System.out.println();
        ...
        System.out.println("Conversion complete in " + (endTime - startTime) + " ms");
        System.out.println();
        ...
        displayCharacters(grayscale, width, height, characters);
